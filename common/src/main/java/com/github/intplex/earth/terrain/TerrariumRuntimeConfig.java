...
public final class TerrariumRuntimeConfig {
    ...
    public static final TileLayerConfig DEFAULT_TERRAIN_TILE_CONFIG = new TileLayerConfig(128, 0);
    public static final TileLayerConfig DEFAULT_RECOVERY_TILE_CONFIG = new TileLayerConfig(128, 0);
    public static final TileLayerConfig DEFAULT_SURFACE_WATER_TILE_CONFIG = new TileLayerConfig(128, 0);
    public static final TileLayerConfig DEFAULT_ECOREGION_TILE_CONFIG = new TileLayerConfig(8, 0);
    ...
    public record TileLayerConfig(int cacheEntries, int prefetchRadius) {
